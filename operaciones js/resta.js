...
function realizarResta(numero1, numero2, indice) {
  ...
  rl.question('Ingresa tu respuesta: ', (respuestaUsuario) => {
    var resultado = {
    ...
    if (indice < 9) {
      realizarResta(generarNumero(), generarNumero(), indice + 1);
    } else {
      mostrarResultados();
      rl.close();
    }
...
function mostrarResultados() {
  ...
  resultados.forEach((resultado, index) => {
    console.log(`Resta ${index + 1}: ${resultado.resta}`);
...
realizarResta(generarNumero(), generarNumero(), 9);
